...
// via Resend.
//
// Required env (set in CF Pages dashboard → Settings → Functions → Production):
...
<div style="font-family:Inter,-apple-system,BlinkMacSystemFont,system-ui,sans-serif;line-height:1.55;color:#0b1729;">
  ...
  <div style="padding:14px 600px;background:#f7f8fa;border-left:4px solid #1f3a5f;white-space:pre-wrap;">${esc(project)}</div>
